...
function Wait(x)
{
    if (x) {document.getElementById('volume_bar').style.opacity='1';clearTimeout(w);}
    else {w = setTimeout(function(){document.getElementById('volume_bar').style.opacity='0';},2000);}
}